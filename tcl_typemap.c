...
/* can't get s_thing with above
	so just interface to typedmess with symbol */
void pd_send(t_symbol *what, t_symbol *sel, int argc, t_atom *argv)
{
	if(what->s_thing) pd_typedmess(what->s_thing, sel, argc, argv);
}
